      ...
      <section className="relative min-h-[90vh] top-0 flex items-center justify-center  bg-transparent">
        ...
        <div className="relative flex w-full max-w-7xl mx-auto items-center justify-center z-10">
          ...
          <div className="mx-auto lg:max-w-7xl w-max-7xl px-5 sm:px-10 md:px-12 z-50 lg:px-5">
            <div className="text-center flex flex-col items-center space-y-10">
              ...
              {/* Main Heading */}
              <h1 className="text-5xl md:text-6xl lg:text-6xl/tight xl:text-6xl/tight text-white font-extrabold max-w-5xl capitalize drop-shadow-lg">
              ...
              <div className="flex justify-center">
                <Link
                  href="#"
                  className="px-8 h-12 rounded-full flex items-center gap-x-3 bg-lime-600/90 text-white font-bold hover:bg-lime-500/90 hover:text-lime-50 shadow-lg transition"
        ...
        >
          <motion.div
            ...
            className="w-8 h-14 border-2 border-lime-400 rounded-full flex justify-center items-start bg-lime-50/80 dark:bg-lime-900/80 shadow-md"
          >
            <motion.div
              animate={{ y: [0, 24, 0] }}
              transition={{ duration: 2, repeat: Infinity }}
              className="w-1.5 h-4 bg-gradient-to-b from-lime-400 to-lime-600 rounded-full mt-2"
            />
          </motion.div>
        </motion.div>
      </section>
